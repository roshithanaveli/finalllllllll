...
/**
 * Servlet implementation class RegisterTraineeafterlogin
 */
@WebServlet("/RegisterTraineeafterlogin")
public class RegisterTraineeafterlogin extends HttpServlet implements Servlet {
	private static final long serialVersionUID = 1L;
	  private static Logger log = Logger.getLogger(RegisterTraineeafterlogin.class.getName());
	    @Override
	    public void init() throws ServletException 
	{
	          ...
	          try {
	               ...
	               File file = new File(dir,"RegisterTraineeafterlogin.log");
     ...
     */
    public RegisterTraineeafterlogin() {
        super();
        ...
        boolean j=UserDAO.insertUser(u,e);
          ...
          if(!j)
          {
          		HttpSession hs=request.getSession();
          			...
          			hs.setAttribute("usernametre", u.getUsername());
          			hs.setAttribute("passwordtre", u.getPassword());
          			
                  System.out.println("success");
                  
                  RequestDispatcher rd= request.getRequestDispatcher("successfullyregisteredtrainee.jsp");
