...
/**
 * Servlet implementation class TraineeRegister
 */
@WebServlet("/TraineeRegister")
public class TraineeRegister extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 private static Logger log = Logger.getLogger(TraineeRegister.class.getName());
	    @Override
	    public void init() throws ServletException 
	{
	          ...
	          try {
	               ...
	               File file = new File(dir,"TraineeRegister.log");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean j=UserDAO.insertUser(u,e);
          ...
          if(!j)
          {
                  ...
                  RequestDispatcher rd= request.getRequestDispatcher("traineesuccessfullyregisteredtrainee.jsp");
